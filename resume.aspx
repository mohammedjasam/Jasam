...
&nbsp;
 ...
 &nbsp;<asp:Image ID="Image6" runat="server" ImageUrl="~/PICS/work.jpg" style="z-index: 1; left: 494px; top: 109px; position: absolute; height: 482px; width: 272px" />
            <br />
        ...
        <asp:ImageButton ID="Image2" runat="server" Height="158px" Width="172px" ImageUrl="~/PICS/resume.jpg" style="margin-left: 0px; z-index: 1; left: 316px; top: 269px; position: absolute;" OnClick="Image2_Click" />
            <br />
 <asp:Image ID="Image7" runat="server" ImageUrl="~/PICS/skill.jpg" style="z-index: 1; left: 770px; top: 108px; position: absolute; height: 482px; width: 259px" />
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
